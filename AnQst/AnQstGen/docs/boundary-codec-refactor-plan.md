...
This execution plan is now historical.

The replacement work described here has been carried through into the active implementation and is superseded for future planning by:

- `AnQst/Tasks/Codec-Architecture-Overhaul-Execution.md`
- `AnQstGen/docs/codec-architecture-alignment-report.md`
- `AnQstGen/docs/codec-architecture-deletion-report.md`
